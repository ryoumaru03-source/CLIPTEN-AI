    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <div className="bg-white max-w-md w-full p-8 rounded-2xl shadow-lg text-center space-y-6">
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900">Clipten AI</h1>
                    <p className="text-gray-500 mt-2">動画の切り抜きを、AIで全自動に。</p>
                </div>

                <button
                    onClick={handleLogin}
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors shadow-sm"
                >
                    {/* Google Logo SVG */}
